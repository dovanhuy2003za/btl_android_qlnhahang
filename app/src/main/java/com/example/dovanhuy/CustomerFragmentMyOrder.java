...
public class CustomerFragmentMyOrder extends AppCompatActivity {

    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    CustomerFragmentMyOrdersAdapter customerFragmentMyOrdersAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customerFragmentMyOrdersAdapter = new CustomerFragmentMyOrdersAdapter(this, arrayList, keylist);
        ...
        databaseReference.orderByChild("Check").equalTo(name+"_payed").addValueEventListener(new ValueEventListener() {
            @Override
