...
public class CustomerFragmentMyOrdersCancelledAdapter extends RecyclerView.Adapter<CustomerFragmentMyOrdersCancelledAdapter.MyViewHolder>{
    ...
    public CustomerFragmentMyOrdersCancelledAdapter(Context context, ArrayList<CustomerFragmentOrdersGet> arrayList, ArrayList<String> keylist) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView Products, Amount, Date, Slot, Quantity, Total;
