...
public class CustomerFragmentParkingAvailableListenerAdapter extends RecyclerView.Adapter<CustomerFragmentParkingAvailableListenerAdapter.MyViewHolder>{
    ...
    public CustomerFragmentParkingAvailableListenerAdapter(Context context, ArrayList<CustomerFragmentParkingSlotGet> arrayList, ArrayList<String> keylist, String txtDate, String tmBox, String bookKey) {
    ...
    @NonNull
    @Override
    public CustomerFragmentParkingAvailableListenerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_avail_slot,parent,false);
        return new CustomerFragmentParkingAvailableListenerAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerFragmentParkingAvailableListenerAdapter.MyViewHolder holder, int position) {
        CustomerFragmentParkingSlotGet slot=arrayList.get(position);
    ...
    private void moveBack() {
        Intent intent = new Intent(context, CustomerFragmentParking.class);
