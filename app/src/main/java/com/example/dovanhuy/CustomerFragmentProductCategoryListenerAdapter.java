...
public class CustomerFragmentProductCategoryListenerAdapter extends RecyclerView.Adapter<CustomerFragmentProductCategoryListenerAdapter.MyViewHolder>{

    Context context;
    ArrayList<CustomerFragmentProductGet> arrayList;
    ArrayList<String> keylist;

    public CustomerFragmentProductCategoryListenerAdapter(Context context, ArrayList<CustomerFragmentProductGet> arrayList, ArrayList<String> keylist) {
    ...
    @NonNull
    @Override
    public CustomerFragmentProductCategoryListenerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.customer_product,parent,false);
        return new CustomerFragmentProductCategoryListenerAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerFragmentProductCategoryListenerAdapter.MyViewHolder holder, int position) {
        CustomerFragmentProductGet products=arrayList.get(position);
