...
import com.example.dovanhuy.WaiterActivity;
...
public class HomeFragmentPrevious extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cancelledProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CancelledPreviousFragment cancelledFragment = new CancelledPreviousFragment();
