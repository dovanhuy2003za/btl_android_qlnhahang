package com.example.dovanhuy.ui.parkStaffView;
...
import com.example.dovanhuy.ParkActivity;
...
public class ParkFragmentFuture extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cancelledProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CancelledParkFragmentFuture cancelledFragment = new CancelledParkFragmentFuture();
