...
public class SlotFragment extends Fragment implements AreaSelectionListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       View root = inflater.inflate(R.layout.fragment_slot, container, false);
    ...
    public void onCategorySelected(int position) {
        ...
        SlotListenerFragment categoryListenerFragment = new SlotListenerFragment();
        FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
        Bundle args = new Bundle();
        args.putString("area", arrayList.get(position));
