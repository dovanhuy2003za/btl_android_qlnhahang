package com.example.dovanhuy.ui.staffrequests;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_staff_requests,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.declineRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Deleted request can't be undo!\n\""+users.getUsername()+"\" will be deleted permanently.");

                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("users").child(users1).removeValue();
                        Toast.makeText(view.getContext(), "Request of user \""+users.getUsername()+"\" Deleted Successfully", Toast.LENGTH_SHORT).show();
                        arrayList.clear();
                        keyList.clear();
                    }
                });
                builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(holder.Email.getContext(), "Request of user \""+users.getUsername()+"\" Deletion Cancelled", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
            }
