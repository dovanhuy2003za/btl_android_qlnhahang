package com.example.dovanhuy.ui.viewAvailPark;
...
import com.example.dovanhuy.ui.home.HomeFragment;
    ...
    private void setUpOnBackPressed() {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(getActivity(), new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if(isEnabled()){
                    setEnabled(false);
                    HomeFragment viewAvailParkFragment = new HomeFragment();
                    FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.container, viewAvailParkFragment).commit();
                }
            }
        });
    }
