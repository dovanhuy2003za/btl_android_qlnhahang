package com.example.dovanhuy.ui.viewAvailTable;
...
public class ViewAvailTableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_view_avail_table, container, false);
...
//                        Query query = parentRef.orderByChild("Customer").equalTo("Admin");
...
//                        });
                        ...
                        AvailTableFragment availTableFragment = new AvailTableFragment();
                        FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                        Bundle args = new Bundle();
                        args.putString("txtDate", txtDate);
                        args.putString("tmBox", tmBox);
                        availTableFragment.setArguments(args);
                        fragmentTransaction.replace(R.id.container, availTableFragment).commit();
                    }
                }
            }
        });
