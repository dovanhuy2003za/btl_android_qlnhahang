...
public class ViewProductsListenerAdapter extends RecyclerView.Adapter<ViewProductsListenerAdapter.MyViewHolder>{
    ...
    public ViewProductsListenerAdapter(Context context, ArrayList<Products> arrayList, ArrayList<String> keylist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.AddKart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                database.orderByChild("Check").equalTo("Admin_"+products1).addValueEventListener(new ValueEventListener() {
                    @Override
                        ...
                        if (snapshot.exists()) {
                            ...
                            builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    hashMap.put("Customer", "Admin");
                                    hashMap.put("Check", "Admin"+"_"+products1);
