...
public class ParkingAvailable extends AppCompatActivity implements ParkingInterface {

    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    ParkingAvailableAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new ParkingAvailableAdapter(this, arrayList, this);
    ...
    public void onCategorySelected(int position) {
        ...
        Intent intent = new Intent(this, ParkingAvailableListener.class);
