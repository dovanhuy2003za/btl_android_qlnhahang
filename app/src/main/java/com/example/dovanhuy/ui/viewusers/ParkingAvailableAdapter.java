...
public class ParkingAvailableAdapter extends RecyclerView.Adapter<ParkingAvailableAdapter.MyViewHolder>{

    Context context;
    ArrayList<String> arrayList;
    private final ParkingInterface parkingInterface;
    DatabaseReference databaseReference;

    public ParkingAvailableAdapter(Context context, ArrayList<String> arrayList, ParkingInterface parkingInterface) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view, parkingInterface);
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View categoryView, ParkingInterface parkingInterface) {
            super(categoryView);
            ...
            categoryView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    parkingInterface.onCategorySelected(pos);
                }
            });
        }
    }
