...
public class ViewHistoryAdapter extends RecyclerView.Adapter<ViewHistoryAdapter.MyViewHolder>{
    ...
    public ViewHistoryAdapter(Context context, ArrayList<Orders> arrayList, ArrayList<String> keylist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        databaseReference.child("Table").child(p2).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Table product = snapshot.getValue(Table.class);
...
// Load custom layout
                    LayoutInflater inflater = LayoutInflater.from(holder.Products.getContext());
                    View dialogView = inflater.inflate(R.layout.dialogthanhtoan, null);
...
// Find the TextView in the dialog layout and set the payment message dynamically
                    TextView paymentMessageTextView = dialogView.findViewById(R.id.paymentMessageTextView);
                    paymentMessageTextView.setText("Số tiền cần thanh toán: "+amount+" VND");
...
// Set up positive and negative buttons for the dialog
                    alertDialogBuilder.setPositiveButton("Confirm Payment", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            databaseReference.child("Book").child(products1).child("Check").setValue(products.getUsername() + "_payed");
                            arrayList.clear();
                            keylist.clear();
...
//                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(holder.Products.getContext());
//                    alertDialogBuilder.setTitle(name);
//                    alertDialogBuilder.setMessage("Pay "+number+" or "+upiId+" of VND"+ amount);
//                    alertDialogBuilder.setPositiveButton("Confirm Payment", new DialogInterface.OnClickListener() {
//                        @Override
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                for (int j = 0; j < p11.length; j++) {
                                    ...
                                    db.child("Product").child(p11[finalJ]).addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshott) {
                                            Product pr = snapshott.getValue(Product.class);
                                ...
                                fragmentTransaction.add(R.id.container, viewUsersFragment);
                    ...
                    (d1.compareTo(d2) < 0)) {
                            ...
                            if (products.getPark().isEmpty()) {
                                ...
                                holder.parkBook.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(context, ParkingAvailable.class);
