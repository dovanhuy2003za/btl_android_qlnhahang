...
public class viewHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewHistoryAdapter = new ViewHistoryAdapter(getActivity(), arrayList, keylist);
        ...
        databaseReference.orderByChild("Check").equalTo(email + "_payed").addValueEventListener(new ValueEventListener() {
            @Override
